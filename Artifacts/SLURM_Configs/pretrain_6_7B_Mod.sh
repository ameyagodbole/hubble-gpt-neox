...
cd /NS/llm-pretraining/work/afkhan/USC_Colab/gpt-neox && python ./deepy.py train.py ./configs/6-7B-modified.yml ./configs/local_setup_wandb_modified_with_slurm.yml